...
var typ = component.MustNewType("awscloudwatchmetrics")

func TestComponentFactoryType_Generated(t *testing.T) {
	require.Equal(t, typ, NewFactory().Type())
}

func TestComponentConfigStruct_Generated(t *testing.T) {
